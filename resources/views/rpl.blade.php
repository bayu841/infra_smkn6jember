...
<section class="h-screen bg-cover bg-center flex items-center justify-center text-black px-6 md:px-0"
  ...
  <div class="flex-1 mb-10 md:mb-0 md:ml-40 text-center md:text-left">
    ...
    <a href="#about"
       class="inline-block bg-red-500 text-white font-semibold py-3 px-6 rounded-md shadow-md transition duration-300 hover:brightness-110 hover:shadow-lg">
       Jelajahi Jurusan
    </a>
  </div>
</section>
...
<section class="about" id="about">
  <div class="flex flex-col md:flex-row items-start md:items-center justify-start px-6 md:px-12 py-10 gap-6 md:gap-4">

    <!-- Bagian kiri (teks) -->
    <div class="md:w-1/2 space-y-3">
      <p class="text-red-500 font-semibold text-sm">Profil Jurusan</p>
      <h2 class="text-2xl md:text-3xl font-bold">Tentang Jurusan</h2>
      ...
      <a href="https://www.youtube.com/shorts/9mQOKXHDnYw?feature=share"
         class="inline-block bg-red-500 text-white text-sm px-4 py-2 rounded-md shadow-md transition duration-300 hover:brightness-110">
        Tonton Video Profil
      </a>
    </div>

    <!-- Bagian kanan (ilustrasi kotak) -->
    <div class="relative w-full max-w-xs md:w-64 h-80 flex-shrink-0 mt-4 md:mt-0">
      ...
      <div class="bg-gray-300 w-full h-full rounded-bl-xl overflow-hidden relative bg-cover bg-center"
        ...
        <div class="absolute bottom-0 left-0 bg-red-500 text-white text-sm font-bold px-4 py-2 rounded-tr-lg">
          Ketua Jurusan RPL
        </div>
      </div>

      <!-- Kotak merah kanan atas -->
      <div class="absolute top-0 right-0 bg-red-500 w-16 h-20 rounded-lg"></div>
    ...
    <div class="flex gap-4 overflow-x-auto snap-x snap-mandatory scroll-smooth no-scrollbar">
        ...
        <div class="shrink-0 w-[85%] snap-start flex gap-2">
            <figure class="relative w-1/2 rounded-xl overflow-hidden shadow-lg">
                <img src="{{ asset('image/rpl/fas1.png') }}" class="w-full h-48 object-cover rounded-xl">
                <figcaption class="absolute left-2 top-2 bg-red-600 text-white font-semibold px-3 py-1 rounded shadow">
                    Lab RPL
                </figcaption>
            </figure>
            <figure class="relative w-1/2 rounded-xl overflow-hidden shadow-lg">
                <img src="{{ asset('image/rpl/fas2.png') }}" class="w-full h-48 object-cover rounded-xl">
                <figcaption class="absolute left-2 top-2 bg-red-600 text-white font-semibold px-3 py-1 rounded shadow">
                    Teaching Factory
                </figcaption>
            </figure>
        ...
        <div class="shrink-0 w-[85%] snap-start flex gap-2">
            <figure class="relative w-1/2 rounded-xl overflow-hidden shadow-lg">
                <img src="{{ asset('image/rpl/fas3.jpg') }}" class="w-full h-48 object-cover rounded-xl">
                <figcaption class="absolute left-2 top-2 bg-red-600 text-white font-semibold px-3 py-1 rounded shadow">
                    Kelas Industri
                </figcaption>
            </figure>
...
<section class="performance">
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 gap-6 px-4 md:px-8">
        ...
        <div class="relative rounded-xl shadow overflow-hidden w-full aspect-[4/3] group">
            <img src="image/rpl/pres1.png" alt="Prestasi 1" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
            <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <p class="text-white font-semibold text-center px-4">Prestasi 1: Juara Coding Competition</p>
            </div>
        </div>

        <!-- Card 2 -->
        <div class="relative rounded-xl shadow overflow-hidden w-full aspect-[4/3] group">
            <img src="image/rpl/pres2.png" alt="Prestasi 2" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
            <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <p class="text-white font-semibold text-center px-4">Prestasi 2: Workshop UI/UX Terbaik</p>
            </div>
        </div>

        <!-- Card 3 -->
        <div class="relative rounded-xl shadow overflow-hidden w-full aspect-[4/3] group">
            <img src="image/rpl/pres3.png" alt="Prestasi 3" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
            <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <p class="text-white font-semibold text-center px-4">Prestasi 3: Juara Hackathon</p>
            </div>
        </div>

        <!-- Card 4 -->
        <div class="relative rounded-xl shadow overflow-hidden w-full aspect-[4/3] group">
            <img src="image/rpl/pres4.png" alt="Prestasi 4" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
            <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <p class="text-white font-semibold text-center px-4">Prestasi 4: Pameran Teknologi</p>
            </div>
        </div>
    </section>
</section>
