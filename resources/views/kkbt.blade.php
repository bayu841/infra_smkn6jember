...
@section('content')
    ...
    <section class="block lg:hidden  px-6 py-14" style="background-color: #CA4016;>
    <div class="text-center mb-6 -mt-10 ">
        <h2 class="text-white text-2xl font-bold">Fasilitas Jurusan</h2>
        <p class="text-white text-sm mt-2">
            Jurusan KKBT memiliki fasilitas lengkap yang mendukung pembelajaran kriya kreatif batik dan tekstil,
            dengan ruang praktik yang memadai serta peralatan membatik dan menenun modern.
        </p>
    </div>

    <div id="slider-mobile-fas" class="flex gap-3 snap-x snap-mandatory overflow-hidden scroll-smooth">
        @foreach ([['fas1' => 'Ruang Batik', 'fas2' => 'Ruang Tenun'], ['fas3' => 'Ruang Desain']] as $pair)
                ...
                <div class="grid grid-cols-2 gap-3">
                    @foreach ($pair as $img => $label)
                        <figure class="relative rounded-xl overflow-hidden shadow group aspect-[4/3]">
                            <img src="{{ asset('image/kkbt/' . $img . '.png') }}" alt="{{ $label }}"
...
<section
    ...
    style="background-image: url('{{ asset('image/kkbt/faskkbt.png') }}')">
    <div class="flex items-start gap-10">
        <!-- Teks -->
        <div class="w-1/3 mt-28">
            <h2 class="text-white text-3xl font-bold mb-4">Fasilitas Jurusan</h2>
            <p class="text-white leading-relaxed">
                Jurusan KKBT memiliki fasilitas lengkap yang menunjang pembelajaran kriya batik dan tekstil,
                mulai dari ruang praktik membatik, ruang desain motif, hingga studio tenun dengan peralatan modern.
            </p>
        </div>
