        ...
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between px-6 md:px-12 py-10 gap-8 md:gap-12">
            ...
            <div class="md:w-1/2 space-y-4">
                ...
                <a href="https://www.youtube.com/shorts/nJRoy5Cf0bE?feature=share"
                   class="inline-block bg-gradient-to-r from-[#CA4016] to-[#E64817] text-white text-sm px-6 py-3 rounded-md shadow-md transition duration-300 hover:brightness-110">
                    Tonton Video Profil
                </a>
            </div>
            ...
            <div class="relative w-full max-w-sm md:w-96 h-96 flex-shrink-0 mt-8 md:mt-0">
                ...
                <div class="bg-gray-300 w-full h-full rounded-bl-2xl rounded-tr-2xl overflow-hidden relative bg-cover bg-center shadow-lg"
                     style="background-image: url('{{ asset('image/kkbt/guru-kkbt.jpg') }}'); background-size: cover; background-position: center;">
                    <div class="absolute bottom-0 left-0 bg-gradient-to-r from-[#CA4016] to-[#E64817] text-white text-base font-bold px-6 py-3 rounded-tr-lg">
                        Ketua Jurusan KKBT
                    </div>
                </div>
            ...
            <div class="relative lg:w-2/3" style="margin-top:-2rem;">
                ...
                <div id="track"
                        ...
                        <div class="grid grid-cols-2 gap-4 h-[400px]">
                            <figure class="relative col-span-2 sm:col-span-1 rounded-2xl overflow-hidden shadow-lg h-full">
                                ...
                                <figcaption class="absolute left-4 top-4">
                                    <span
                                        class="inline-flex rounded-e-2xl rounded-s-xl bg-gradient-to-r from-[#CA4016] to-[#E64817] text-white font-semibold px-4 py-2 shadow">
                                        Lab KKBT
                                    </span>
                                </figcaption>
                            </figure>
                    ...
                    <div class="shrink-0 w-[90%] lg:w-[85%] snap-start">
                        <div class="grid grid-cols-2 gap-4 h-[400px]">
                            <figure class="relative col-span-2 sm:col-span-1 rounded-2xl overflow-hidden shadow-lg h-full">
                                <img class="w-full h-full object-cover" src="{{ asset('image/kkbt/fas3.jpg') }}"
                                    style="height:100%;">
                                <figcaption class="absolute left-4 top-4">
                                    <span
                                        class="inline-flex rounded-e-2xl rounded-s-xl bg-gradient-to-r from-[#CA4016] to-[#E64817] text-white font-semibold px-4 py-2 shadow">
                            ...
                            <figure class="relative col-span-2 sm:col-span-1 rounded-2xl overflow-hidden shadow-lg h-full">
                                <img class="w-full h-full object-cover" src="{{ asset('image/kkbt/fas4.jpg') }}"
                                    style="height:100%;">
                                <figcaption class="absolute left-4 top-4">
                                    <span
                                        class="inline-flex rounded-e-2xl rounded-s-xl bg-gradient-to-r from-[#CA4016] to-[#E64817] text-white font-semibold px-4 py-2 shadow">
            ...
            <div class="relative flex justify-center lg:w-1/2">
                ...
                <div class="relative">
                    ...
                    <img src="{{asset('image/kkbt/jenus.png')}}"
                        class="absolute -bottom-10 -right-10 w-[130px] h-[130px] object-cover shadow-lg z-20"
                        alt="bottom">
