...
@section('content')
  ...
  <div class="flex-1 mb-10 md:mb-0 md:ml-40 text-center md:text-left">
    ...
    <a href="#about"
       class="inline-block bg-green-500 text-white font-semibold py-3 px-6 rounded-md shadow-md transition duration-300 hover:brightness-110 hover:shadow-lg">
       Jelajahi Jurusan
    </a>
  </div>
</section>
  ...
  <div class="flex flex-col md:flex-row items-start md:items-center justify-start px-6 md:px-12 py-10 gap-6 md:gap-4">
    ...
    <div class="md:w-1/2 space-y-3">
      ...
      <a href="https://www.youtube.com/shorts/wuSu15-Jugk?feature=share"
         class="inline-block bg-green-500 text-white text-sm px-4 py-2 rounded-md shadow-md transition duration-300 hover:brightness-110">
        Tonton Video Profil
      </a>
    </div>
    ...
    <div class="relative w-full max-w-xs md:w-64 h-80 flex-shrink-0 mt-4 md:mt-0">
      ...
      <div class="bg-gray-300 w-full h-full rounded-bl-xl overflow-hidden relative bg-cover bg-center"
        ...
        <div class="absolute bottom-0 left-0 bg-green-500 text-white text-sm font-bold px-4 py-2 rounded-tr-lg">
          Ketua Jurusan AKL
        </div>
      </div>
        ...
        <section class="bg-[#f5f5f5] py-20">
            <div class="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-14 px-6">
                ...
                <div class="relative flex justify-center lg:w-1/2">
                    <!-- Gambar utama -->
                    <div class="relative">
                        <img src="{{ asset('image/akl/gambarhsjr.png') }}"
                            class="rounded-3xl w-[360px] h-[440px] object-cover shadow-xl" alt="main">

                        <!-- Gambar kiri atas -->
                        <img src="{{ asset('image/akl/gambaratas.png') }}"
