...
@section('content')
    ...
    <section class="block lg:hidden bg-green-500 px-6 py-14">
        <div class="text-center mb-6">
            <h2 class="text-white text-2xl font-bold">Fasilitas Jurusan</h2>
            <p class="text-white text-sm mt-2">
                Fasilitas lengkap dengan laboratorium akuntansi modern dan software terbaru untuk mendukung teori dan
                praktik belajar.
            </p>
        </div>

        <div id="slider-mobile-fas" class="flex gap-3 snap-x snap-mandatory overflow-hidden scroll-smooth">
                    @foreach ([['fas1' => 'Lab Akl', 'fas2' => 'Pawon Enem']] as $pair)
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        @foreach ($pair as $img => $label)
                            <figure class="relative rounded-xl overflow-hidden shadow group aspect-[4/3]">
                                <img src="{{ asset('image/akl/' . $img . '.png') }}" alt="{{ $label }}"
    ...
    <section
        ...
        style="background-image: url('{{ asset('image/akl/fasakl.png') }}')">
                ...
                <div class="space-y-4">
                    <div
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm">Mengasah kemampuan analisis dan ketelitian siswa akuntansi.
                            </p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm">Menerapkan ilmu akuntansi melalui simulasi dunia kerja nyata.
                            </p>
                        </div>
                    </div>
                </div>
