...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('image/logosmk.png') }}" type="image/x-icon">
        ...
        <div class="container mx-auto px-4 flex items-center justify-between h-16">
            ...
            <div class="flex items-center space-x-2">
                <div class="lazy-image-container w-10 h-10 rounded-full">
                    ...
                    <img data-src="{{ asset('image/logosmk.png') }}" alt="Logo"
                        class="lazy-image w-10 h-10 rounded-full object-cover">
                </div>
            </div>
            ...
            <ul id="menu"
                ...
                <li class="relative">
                    <button data-target="profilDropdown"
                        class="dropdown-toggle flex items-center text-black hover:text-blue-600 w-full lg:w-auto">
                        Profil
                ...
                <li><a href="/#jurusan" class="block text-black hover:text-blue-600">Jurusan</a></li>
                <li class="relative">
                    ...
                    <ul id="informasiDropdown"
                        class="hidden lg:absolute left-0 mt-2 w-40 bg-white rounded shadow-md z-10">
                        <li><a href="{{ route('berita.index') }}" class="block px-4 py-2 hover:bg-gray-100">Berita</a>
                        </li>
                        <li><a href="https://spmbjatim.net/" target="_blank"
                                class="block px-4 py-2 hover:bg-gray-100">SPMB</a></li>
                    </ul>
                </li>

                <li class="relative">
                    <button data-target="produkDropdown"
                        class="dropdown-toggle flex items-center text-black hover:text-blue-600 w-full lg:w-auto">
                        Produk Kami
                        <svg class="ml-1 w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M5.25 7.5L10 12.25L14.75 7.5H5.25Z" clip-rule="evenodd" />
            ...
            <i class="fas fa-search absolute left-2 top-2 text-gray-500"></i>
                    ...
                    @auth
                        <a href="{{ route('admin.dashboard') }}"
                            class="text-white px-4 py-2 rounded spmb text-center">Dashboard</a>
                    @else
      ...
      <form action="{{ route('berita.index') }}" method="GET">
        <div class="relative">
          ...
          <i class="fas fa-search absolute left-2 top-2 text-gray-500"></i>
                ...
                @auth
                    <a href="{{ route('admin.dashboard') }}"
                        class="text-white px-4 py-2 rounded hover:bg-blue-700 spmb">Dashboard</a>
                @else
