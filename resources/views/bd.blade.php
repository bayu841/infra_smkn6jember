...
@section('content')
        ...
        <div class="flex flex-col md:flex-row items-start justify-between px-6 md:px-12 py-10 gap-1 ml-10">
            ...
            <div class="relative w-64 h-80 card-profile">
                ...
                <div class="bg-gray-300 w-full h-full rounded-bl-xl overflow-hidden relative bg-cover bg-center"
                    style="background-image: url('{{ asset('image/bd/guru1.png') }}')">
                    <!-- Label bawah -->
                    <div
                ...
                <div class="absolute top-0 right-0 bg-yellow-400 w-16 h-20 rounded-lg red-box"></div>
    ...
    <!-- === MOBILE === -->
<section class="block lg:hidden bg-yellow-300 px-6 py-14">
    <div class="text-center mb-6">
        <h2 class="text-white text-2xl font-bold">Fasilitas Jurusan</h2>
        <p class="text-white text-sm mt-2">
            Jurusan BD memiliki fasilitas lengkap yang mendukung pembelajaran bisnis digital dan praktik kewirausahaan.
        </p>
    </div>

    <div id="slider-mobile-fas" class="flex gap-3 snap-x snap-mandatory overflow-hidden scroll-smooth">
        @foreach ([['fas1' => 'Lab Pemasaran', 'fas2' => 'Tefa'], ['fas3' => 'Lab Komputer']] as $pair)
                ...
                <div class="grid grid-cols-2 gap-3">
                    @foreach ($pair as $img => $label)
                        <figure class="relative rounded-xl overflow-hidden shadow group aspect-[4/3]">
                            <img src="{{ asset('image/bd/' . $img . '.png') }}" alt="{{ $label }}"
...
<section
    ...
    style="background-image: url('{{ asset('image/bd/fasbd.png') }}')">
    <div class="flex items-start gap-10">
        <!-- Teks -->
        <div class="w-1/3 mt-28">
            <h2 class="text-white text-3xl font-bold mb-4">Fasilitas Jurusan</h2>
            <p class="text-white leading-relaxed">
                Jurusan BD memiliki fasilitas lengkap yang mendukung pembelajaran digital marketing,
                dilengkapi perangkat modern dan software terbaru untuk menunjang proses belajar.
            </p>
        </div>
...
<script>
                ...
                <div class="space-y-4">
                    <div
                        ...
                        <div class="bg-gradient-to-r from-[#FFBB00] to-[#FD9024] text-white p-3 rounded-full">
                            <div class="w-5 h-5">
                                <img src="{{ asset('image/bd/Group (2).png') }}" alt="Bag Icon"
                                    class="w-full h-full object-contain">
                            </div>
                        </div>
                        <div>
                            <h4 class="font-semibold text-gray-900">Serving with Style</h4>
                            <p class="text-gray-500 text-sm">Melatih sikap ramah, profesional, dan cepat tanggap saat
                    ...
                    <div
                        ...
                        <div class="bg-gradient-to-r from-[#FFBB00] to-[#FD9024] text-white p-3 rounded-full">
                            <div class="w-5 h-5">
                                <img src="{{ asset('image/bd/Group (3).png') }}" alt="Bag Icon"
                                    class="w-full h-full object-contain">
                            </div>
                        </div>
                        <div>
                            <h4 class="font-semibold text-gray-900">Digital Marketing Practice</h4>
                            <p class="text-gray-500 text-sm">Menerapkan strategi promosi online untuk meningkatkan
                                penjualan cafe enem</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="cta mt-8">
        ...
        <div class="cta-btn">
            <a href="https://www.instagram.com/marketing_skanamber/" class="btn1">Selengkapnya</a>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function openVideoModal() {
                ...
                frame.src = "https://www.youtube.com/embed/xf9Gi6l9eKc";
