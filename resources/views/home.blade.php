...
<style>
  ...
  .brand img { width: 50px; height: 50px; object-fit: cover; border-radius: 9999px; }

  /* About offset */
  .about { margin-left: 6rem; margin-top: 3rem; }
  @media (max-width: 1024px) {
    .about { margin-left: 0; padding: 0 1rem; }
  }
  ...
  .card p, .card-1 p { padding: 24px; padding-top: 6rem; }
  .card p { color: #fff; }
  .card-1 p { color: #000; }

  .red-box { margin-top: -2rem; height: 15vh; background-color: #1e6891; }
  .card-profile { margin-right: 8rem; }
  @media (max-width: 1024px) {
    .card, .card-1 { margin-left: 0; }
    .card-profile { margin-right: 0; margin-top: 1rem; }
  }

  .title-box { background: linear-gradient(to right, #3C71F8, #24437C); }
  ...
  .text-major { margin-top: 14rem; }
  @media (max-width: 640px) { .text-major { margin-top: 10rem; } }

  .study { background-image: url('image/rpl/pemrpl.png'); background-size: cover; background-position: center; }
  .study h2 { padding-top: 13rem; }

  .class { margin-left: 5rem; }
  ...
  @media (max-width: 1024px) {
    .teacher { grid-template-columns: repeat(2, 1fr); padding: 0 1rem; }
  }
  ...
  .lazy-image-container { position: relative; display: block; overflow: hidden; }
  .image-placeholder {
    position: absolute; inset: 0; display:flex; align-items:center; justify-content:center;
    background: rgba(0,0,0,0.04);
  }
  .placeholder-spinner {
    width: 28px; height: 28px; border: 3px solid #cbd5e1; border-top-color: #3C71F8; border-radius: 50%; animation: spin 1s linear infinite;
  }
  @keyframes spin { to { transform: rotate(360deg) } }
  .lazy-image { opacity: 0; transition: opacity .4s ease; display: block; width: 100%; height: 100%; object-fit: cover; }
  ...
  .hero-content { width: 100%; max-width: 1200px; padding: 0 1rem; display: flex; gap: 1.5rem; }
  ...
  @media (max-width: 768px) {
    .brand { grid-template-columns: repeat(5, minmax(0, 1fr)); border-radius: 14px; margin-top: -2rem; }
  }
  @media (max-width: 480px) {
    .brand { grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 10px; padding: 10px; }
    .brand img { width: 44px; height: 44px; }
  }

  /* Ekstrakurikuler track item width on mobile */
  .eskul-slide { width: 100%; max-width: 850px; height: auto; }
  .eskul-figure { aspect-ratio: 4/5; width: 100%; }
  @media (min-width: 1024px) {
    .eskul-figure { height: 50vh; aspect-ratio: auto; }
  }
...
<div class="brand">
  ...
  @php
    $brands = [
      ['image' => 'image/logoinfra.png', 'alt' => 'Infra'],
      ['image' => 'image/logokom.png', 'alt' => 'Kom'],
      ['image' => 'image/logomaspion.png', 'alt' => 'Maspion'],
      ['image' => 'image/logoiqo.png', 'alt' => 'IQO'],
      ['image' => 'image/logorpl.png', 'alt' => 'RPL'],
      ['image' => 'image/logobd.png', 'alt' => 'BD'],
      ['image' => 'image/logoak.png', 'alt' => 'AK'],
      ['image' => 'image/logomp.png', 'alt' => 'MP'],
      ['image' => 'image/logodkv.png', 'alt' => 'DKV'],
      ['image' => 'image/logokkbt.png', 'alt' => 'KKBT'],
      ['image' => 'image/brand1.png', 'alt' => 'Brand 1'],
      ['image' => 'image/brand2.png', 'alt' => 'Brand 2'],
      ['image' => 'image/brand3.png', 'alt' => 'Brand 3'],
      ['image' => 'image/brand4.png', 'alt' => 'Brand 4'],
    ];
  @endphp
  @foreach ($brands as $b)
...
<section class="about">
  <div class="flex flex-col md:flex-row items-start justify-between px-4 md:px-12 py-10 gap-6 md:gap-1 md:ml-10">
    ...
    <div class="relative w-full max-w-xs sm:max-w-sm md:w-64 h-96 card-profile mx-auto md:mx-0">
      <!-- Card Utama -->
...
<section class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
  ...
  <div class="relative">
    ...
    <div id="track" class="no-scrollbar overflow-x-auto scroll-smooth snap-x snap-mandatory flex gap-6 sm:gap-8 pb-3">
      <!-- Slide 1 -->
      <article class="min-w-[85%] sm:min-w-[46%] lg:min-w-[31%] snap-start rounded-2xl bg-white shadow ring-1 ring-slate-100 fade-in">
        <div class="card-grad-1 rounded-t-2xl overflow-hidden">
          <div class="h-48 sm:h-60 lazy-image-container">
            ...
            <img class="lazy-image w-full h-full object-cover" data-src="image/home/rpl.png" alt="Rekayasa Perangkat Lunak">
            <div class="-mt-5 px-5">
              <span class="inline-block px-4 py-2 rounded-full bg-red-600 text-white text-sm font-semibold shadow text-major">
      ...
      <article class="min-w-[85%] sm:min-w-[46%] lg:min-w-[31%] snap-start rounded-2xl bg-white shadow ring-1 ring-slate-100 fade-in">
        <div class="card-grad-1 rounded-t-2xl overflow-hidden">
          <div class="h-48 sm:h-60 lazy-image-container">
            <div class="image-placeholder"><div class="placeholder-spinner"></div></div>
            <img class="lazy-image w-full h-full object-cover" data-src="image/home/bd.png" alt="Bisnis Digital">
            <div class="-mt-5 px-5">
              <span class="inline-block px-4 py-2 rounded-full bg-orange-600 text-white text-sm font-semibold shadow text-major">
                Bisnis Digital
              </span>
            </div>
          </div>
      ...
      <article class="min-w-[85%] sm:min-w-[46%] lg:min-w-[31%] snap-start rounded-2xl bg-white shadow ring-1 ring-slate-100 fade-in">
        <div class="card-grad-1 rounded-t-2xl overflow-hidden">
          <div class="h-48 sm:h-60 lazy-image-container">
            <div class="image-placeholder"><div class="placeholder-spinner"></div></div>
            <img class="lazy-image w-full h-full object-cover" data-src="image/home/akl.png" alt="Akuntansi">
            <div class="-mt-5 px-5">
              <span class="inline-block px-4 py-2 rounded-full bg-green-600 text-white text-sm font-semibold shadow text-major">
                Akuntansi
              </span>
            </div>
          </div>
...
<section class="fasility bg-slate-900 px-4 md:px-10 py-16 md:py-20">
  <div class="flex flex-col lg:flex-row items-start gap-10">
    <!-- Teks -->
    <div class="lg:w-1/3 ml-0 md:ml-5" style="margin-top: 0;">
    ...
    <div class="relative lg:w-2/3 -mt-2">
      <div id="track2" class="flex gap-4 px-2 py-2 overflow-x-auto snap-x snap-mandatory scroll-smooth no-scrollbar">
        <!-- Slide 1 -->
        <div class="shrink-0 eskul-slide snap-start">
          <div class="grid grid-cols-2 gap-3">
            <figure class="relative col-span-2 sm:col-span-1 rounded-xl overflow-hidden shadow group eskul-figure">
              <img src="{{ asset('image/eskul/paskib.png') }}" alt="Paskibraka" class="w-full h-full object-cover transition duration-500 group-hover:scale-105" />
            ...
            <figure class="relative col-span-2 sm:col-span-1 rounded-xl overflow-hidden shadow group eskul-figure">
              <img src="{{ asset('image/eskul/pmr.png') }}" alt="PMR" class="w-full h-full object-cover transition duration-500 group-hover:scale-105" />
              <div class="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition duration-500 flex items-center justify-center">
        ...
        <div class="shrink-0 eskul-slide snap-start">
          <div class="grid grid-cols-2 gap-3">
            <figure class="relative col-span-2 sm:col-span-1 rounded-xl overflow-hidden shadow group eskul-figure">
              <img src="{{ asset('image/eskul/tari.png') }}" alt="Sanggar Tari" class="w-full h-full object-cover transition duration-500 group-hover:scale-105" />
              <div class="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition duration-500 flex items-center justify-center">
                <span class="text-white text-xl font-semibold">Sanggar Tari</span>
              </div>
            </figure>
            <figure class="relative col-span-2 sm:col-span-1 rounded-xl overflow-hidden shadow group eskul-figure">
              <img src="{{ asset('image/rpl/fas2.png') }}" alt="Marching Band" class="w-full h-full object-cover transition duration-500 group-hover:scale-105" />
              <div class="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition duration-500 flex items-center justify-center">
        ...
        <div class="shrink-0 eskul-slide snap-start">
          <div class="grid grid-cols-2 gap-3">
            <figure class="relative col-span-2 sm:col-span-1 rounded-xl overflow-hidden shadow group eskul-figure">
              <img src="{{ asset('image/rpl/fas1.png') }}" alt="Hadroh" class="w-full h-full object-cover transition duration-500 group-hover:scale-105" />
              <div class="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition duration-500 flex items-center justify-center">
                <span class="text-white text-xl font-semibold">Hadroh</span>
              </div>
            </figure>
            <figure class="relative col-span-2 sm:col-span-1 rounded-xl overflow-hidden shadow group eskul-figure">
              <img src="{{ asset('image/rpl/fas2.png') }}" alt="Osis" class="w-full h-full object-cover transition duration-500 group-hover:scale-105" />
              <div class="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition duration-500 flex items-center justify-center">
...
<section class="bg-gray-50 py-16">
  <div class="max-w-5xl mx-auto text-center px-4">
    ...
    <div class="mt-10">
      <a href="#" class="px-6 py-2.5 rounded-lg bg-gradient-to-r from-blue-600 to-blue-900 text-white font-semibold hover:opacity-90 transition">
        Selengkapnya
      </a>
    </div>
  </div>

  <section class="bg-cover bg-center rounded-2xl overflow-hidden flex flex-col md:flex-row items-center justify-between px-6 md:px-8 py-10 md:py-16 text-white max-w-6xl mx-auto mt-20 min-h-[380px]"
  ...
  <div class="font-poppins bg-gray-100 flex items-center justify-center p-4 md:p-8">
    <div class="container max-w-6xl w-full flex flex-col lg:flex-row gap-6 md:gap-8">
      ...
      <div class="w-full lg:w-1/3">
        <div class="bg-gradient-to-br from-blue-500 to-blue-700 text-white p-6 md:p-8 rounded-xl shadow-2xl flex flex-col gap-4 md:gap-6" style="min-height: 360px;">
      ...
      <div class="w-full lg:w-2/3 grid grid-cols-2 grid-rows-2 gap-4 md:gap-6" style="min-height: 360px;">
        ...
        <div class="rounded-xl overflow-hidden shadow-lg row-span-2">
          <div class="lazy-image-container w-full h-full">
            <div class="image-placeholder"><div class="placeholder-spinner"></div></div>
            <img class="lazy-image w-full h-full object-cover" data-src="https://picsum.photos/seed/counseling2/600/800.jpg" alt="Konseling">
          </div>
        </div>
        <div class="rounded-xl overflow-hidden shadow-lg row-span-2">
          <div class="lazy-image-container w-full h-full">
            <div class="image-placeholder"><div class="placeholder-spinner"></div></div>
            <img class="lazy-image w-full h-full object-cover" data-src="https://picsum.photos/seed/counseling3/600/800.jpg" alt="Sesi konseling">
          </div>
        </div>
        <div class="rounded-xl overflow-hidden shadow-lg">
  ...
  <!-- Footer contact -->
  <section class="w-full flex flex-col lg:flex-row items-center justify-between px-4 md:px-10 lg:px-20 py-12 footer-hero"
    ...
    <div class="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
      <h2 class="text-2xl lg:text-3xl font-bold text-gray-900 leading-snug mb-6">
        Bergabunglah bersama kami dan wujudkan masa depan mu
      </h2>
    </div>

    <div class="w-full lg:w-1/2 mt-6 lg:mt-0 bg-white p-6 md:p-8 shadow-lg rounded-2xl">
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    function updateDots() {
      ...
      for (let i = 0; i < pageCount; i++) {
        ...
        dot.className = "size-2.5 sm:size-3 rounded-full bg-slate-300 data-[active=true]:bg-blue-600 transition";
        dot.dataset.index = i;
    ...
    let isPointerDown = false, startX = 0, startLeft = 0;
    ...
    track2.addEventListener('mouseleave', () => { isPointerDown = false; });
    ...
    function updateDots2() {
      ...
      for (let i = 0; i < pageCount; i++) {
        ...
        dot.addEventListener("click", () => {
          ...
          track2.scrollTo({ left: target, behavior: "smooth" });
          scrollAmount = target;
        });
    ...
    function setActiveDot2() {
      ...
      [...dotsWrap2.children].forEach((dot, i) => { dot.dataset.active = i === activePage; });
    }
    ...
    function showNotification(message, type) {
      ...
      notification.className = `fixed top-4 right-4 px-6 py-3 rounded-lg shadow-lg text-white ${type === 'success' ? 'bg-green-500' : 'bg-red-500'} transform transition-transform duration-300 translate-x-full z-50`;
