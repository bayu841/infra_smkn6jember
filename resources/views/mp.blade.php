...
@section('content')
    ...
    <section class="h-screen bg-cover bg-center flex items-center justify-center text-black px-6 md:px-0"
        ...
        <div class="flex-1 mb-10 md:mb-0 md:ml-40 text-center md:text-left">
            ...
            <a href="#about"
               class="inline-block bg-gradient-to-r from-[#4D4FF5] to-[#7A44F9] text-white font-semibold py-3 px-6 rounded-md shadow-md transition duration-300 hover:brightness-110 hover:shadow-lg">
               Daftar Sekarang
            </a>
        </div>
    </section>
    ...
    <section class="about" id="about">
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between px-6 md:px-12 py-10 gap-8 md:gap-12">
            ...
            <div class="md:w-1/2 space-y-4">
                ...
                <a href=""
                   class="inline-block bg-gradient-to-r from-[#4D4FF5] to-[#7A44F9] text-white text-sm px-6 py-3 rounded-md shadow-md transition duration-300 hover:brightness-110">
                    Tonton Video Profil
                </a>
            </div>
            ...
            <div class="relative w-full max-w-sm md:w-96 h-96 flex-shrink-0 mt-8 md:mt-0">
                ...
                <div class="bg-gray-300 w-full h-full rounded-bl-2xl rounded-tr-2xl overflow-hidden relative bg-cover bg-center shadow-lg"
                     style="background-image: url('{{ asset('image/mp/guru-mp.jpg') }}'); background-size: cover; background-position: center;">
                    <div class="absolute bottom-0 left-0 bg-gradient-to-r from-[#4D4FF5] to-[#7A44F9] text-white text-base font-bold px-6 py-3 rounded-tr-lg">
                        Ketua Jurusan MP
                    </div>
                </div>
    ...
    <section class="max-w-6xl mx-auto px-6 py-12 grid md:grid-cols-2 gap-8 items-start md:items-center">
        ...
        <div class="mt-10 md:mt-0">
            <div class="content-teks ml-0 md:ml-8">
                ...
                <button class="bg-gradient-to-r from-[#4D4FF5] to-[#7A44F9] hover:brightness-110 text-white px-6 py-3 rounded-lg font-semibold transition duration-300">
                    Selengkapnya
                </button>
            </div>
        </div>
            ...
            <div class="relative lg:w-2/3" style="margin-top:-2rem;">
                ...
                <div id="track"
                        ...
                        <div class="grid grid-cols-2 gap-4 h-[400px]">
                            <figure class="relative col-span-2 sm:col-span-1 rounded-2xl overflow-hidden shadow-lg h-full">
                                ...
                                <figcaption class="absolute left-4 top-4">
                                    <span
                                        class="inline-flex rounded-e-2xl rounded-s-xl bg-gradient-to-r from-[#4D4FF5] to-[#7A44F9] text-white font-semibold px-4 py-2 shadow">
                                        Lab OTKP
                                    </span>
                                </figcaption>
                            </figure>
                    ...
                    <div class="shrink-0 w-[90%] lg:w-[85%] snap-start">
                        <div class="grid grid-cols-2 gap-4 h-[400px]">
                            <figure class="relative col-span-2 sm:col-span-1 rounded-2xl overflow-hidden shadow-lg h-full">
                                <img class="w-full h-full object-cover" src="{{ asset('image/mp/fas3.jpg') }}"
                                    style="height:100%;">
                                <figcaption class="absolute left-4 top-4">
                                    <span
                                        class="inline-flex rounded-e-2xl rounded-s-xl bg-gradient-to-r from-[#4D4FF5] to-[#7A44F9] text-white font-semibold px-4 py-2 shadow">
                            ...
                            <figure class="relative col-span-2 sm:col-span-1 rounded-2xl overflow-hidden shadow-lg h-full">
                                <img class="w-full h-full object-cover" src="{{ asset('image/mp/fas4.jpg') }}"
                                    style="height:100%;">
                                <figcaption class="absolute left-4 top-4">
                                    <span
                                        class="inline-flex rounded-e-2xl rounded-s-xl bg-gradient-to-r from-[#4D4FF5] to-[#7A44F9] text-white font-semibold px-4 py-2 shadow">
                ...
                <div class="space-y-4">
                    <div
                        ...
                        <div class="bg-gradient-to-r from-[#4D4FF5] to-[#7A44F9] text-white p-3 rounded-full">
                            <div class="w-5 h-5">
                                <img src="{{ asset('image/mp/icon1.png') }}" alt="Bag Icon"
                                    class="w-full h-full object-contain">
                            </div>
                        </div>
                        <div>
                            <h4 class="font-semibold text-gray-900">Pelatihan Administrasi Digital</h4>
                            <p class="text-gray-500 text-sm">Menguasai software administrasi modern untuk kebutuhan perkantoran.</p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="bg-gradient-to-r from-[#4D4FF5] to-[#7A44F9] text-white p-3 rounded-full">
                            <div class="w-5 h-5">
                                <img src="{{ asset('image/mp/icon2.png') }}" alt="Bag Icon"
                                    class="w-full h-full object-contain">
                            </div>
                        </div>
                        <div>
                            <h4 class="font-semibold text-gray-900">Public Speaking & Komunikasi</h4>
                            <p class="text-gray-500 text-sm">Meningkatkan kemampuan presentasi dan komunikasi profesional.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="performance">
        ...
        <section class="grid grid-cols-1 md:grid-cols-2 gap-6 px-4 md:px-8 max-w-7xl mx-auto">
            ...
            <div class="col-span-1 md:col-span-2 flex justify-center mt-8">
                <a href="" class="bg-gradient-to-r from-[#4D4FF5] to-[#7A44F9] text-white font-semibold py-3 px-8 rounded-lg shadow-md transition duration-300 hover:brightness-110 hover:shadow-lg text-center">
                    Selengkapnya
                </a>
            </div>
        </section>
    ...
    <section class="cta mt-8 py-20">
        <div class="text-center px-6">
            ...
            <div class="cta-btn">
                <a href="" class="btn1 text-lg px-8 py-3">Daftar Sekarang</a>
                <a href="" class="btn2 text-lg px-8 py-3">Lihat Lainnya</a>
            </div>
        </div>
    </section>
