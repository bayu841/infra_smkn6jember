    ...
    <section>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 px-6 mb-10">
            <div class="rounded-lg overflow-hidden shadow-lg">
                <img src="{{ asset('image/branding/batik1 (1).png') }}" alt="Produk" class="w-full h-full object-cover">
            </div>

            <div class="rounded-lg overflow-hidden shadow-lg">
                <img src="{{ asset('image/branding/batik1 (2).png') }}" alt="Produk" class="w-full h-full object-cover">
            </div>

            <div class="rounded-lg overflow-hidden shadow-lg">
                <img src="{{ asset('image/branding/batik1 (3).png') }}" alt="Produk" class="w-full h-full object-cover">
            </div>
        </div>
    </section>

    <br><br><br>
    <section class="bg-gradient-to-r from-[#CA4016] to-[#E64817]  py-10 px-6 md:px-16" style="height:60vh;">
