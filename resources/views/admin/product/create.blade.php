            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" rows="3"
                        class="mt-2 w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 transition"></textarea>
                </div>
...
$(document).ready(function() {
    ...
    $('#productForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            contentType: false,
            success: function() {
                progressBar.css('background-color', '#10b981'); // hijau ketika selesai
                setTimeout(() => window.location.href = "{{ route('admin.products.index') }}", 500);
            },
            error: function() {
