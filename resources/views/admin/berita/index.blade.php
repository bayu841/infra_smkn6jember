        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex gap-3">
                <a href="{{ route('admin.news.import') }}"
                   class="inline-flex items-center gap-2 bg-gradient-to-r from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 text-white font-semibold py-3 px-5 rounded-xl shadow-md transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="text-xs text-gray-500 mt-1 flex items-center gap-2">
                                    <span class="inline-flex items-center gap-1 bg-green-100 text-green-800 px-2 py-0.5 rounded-full text-xs">
                                        ...
                                        @php
                                            $views = $berita->views;
                                            echo $views >= 1000 ? round($views / 1000, 1) . 'k dilihat' : $views . ' dilihat';
                                        @endphp
                                    </span>
                                </div>
                            </td>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        selectAllCheckbox.addEventListener('change', function () {
            newsCheckboxes.forEach(cb => cb.checked = this.checked);
            toggleDeleteButton();
        });
        ...
        function toggleDeleteButton() {
            const anyChecked = Array.from(newsCheckboxes).some(cb => cb.checked);
